...
#19点青客仿真关机
$sql="select resname,name from azurevm where state=1 and  vmtype=1 and nopoweroff!=1";
...
#19点青客测试关机
$sql="select resname,name from azurevm where state=1 and  vmtype=2 and nopoweroff!=1";
$command = New-Object MySql.Data.MySqlClient.MySqlCommand($sql, $connection)
$dataAdapter = New-Object MySql.Data.MySqlClient.MySqlDataAdapter($command)
$ds = New-Object System.Data.DataSet
$recordCount = $dataAdapter.Fill($ds)
